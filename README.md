...
- ❌ Изменение ролей администраторов недоступно (только тренеры и гости)
...
### Главный экран
*Адаптивная навигация с 5 вкладками*

### Управление составом
*Поиск, фильтры, сортировка игроков*

### Формирование звеньев
*Drag-and-drop с валидацией*
...
Проект создан в образовательных целях. Для предложений и улучшений создавайте Issues или Pull Requests.
